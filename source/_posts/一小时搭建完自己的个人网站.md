...
update 2024.06.24: 根据目前 Hexo 和 NexT 的最新版本更新，保证步骤跨平台，新增使用 GitHub Actions 实现自动部署，为了解决图片链接细节问题自己写了个 Hexo 插件。

update 2024.06.25: 为了方便导入 Markdown 到知乎文章编辑器自己写了个 Hexo 插件。
